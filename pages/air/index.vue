    ...
    <div class="air-sale">
      <el-row type="flex" class="air-sale-pic" justify="space-between">
        <el-col :span="6" v-for="(item, index) in sales" :key="index">
          ...
          >
            <img src="https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3602996315,708314624&fm=26&gp=0.jpg" />
...
<script>
import Search from "@/components/air/search";
export default {
  data() {
    return {
      sales: [
        {
          cover:
            "https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3602996315,708314624&fm=26&gp=0.jpg",
          departCity: "广州",
          departCode: "CAN",
